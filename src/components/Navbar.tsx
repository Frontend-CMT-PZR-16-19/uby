  ...
  const NavLinks: NavLink[] = [
    {
      ...
      href: '/kurslar',
      subContent: [
        { title: "Makina", href: "/kurslar/makine-egitimleri" },
        { title: "Yazılım", href: "/kurslar/yazilim" },
        { title: "İnşaat", href: "/kurslar/insaat" },
        { title: "Mimari", href: "/kurslar/mimari" },
        { title: "Robotik Otomasyon ve PLC", href: "/kurslar/robotik-otomasyon-ve-plc" },
        { title: "İngilizce", href: "/kurslar/ingilizce" },
        { title: "Mesleki Bilişim", href: "/kurslar/mesleki-bilisim" },
        { title: "Grafik Video ve Web Tasarım", href: "/kurslar/grafik-video-ve-web-tasarim" },
        { title: "Dijital Oyun ve Animasyon", href: "/kurslar/dijital-oyun-ve-animasyon" },
      ]
    },
    {
      title: "Blog",
